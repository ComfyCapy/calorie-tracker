...
namespace CalorieTracker.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<SavedCapyOutfit> SavedCapyOutfits { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<SavedCapyOutfit>()
                .HasOne<ApplicationUser>()
                .WithMany()
                .HasForeignKey(outfit => outfit.UserId)
                .OnDelete(DeleteBehavior.Cascade);

            builder.Entity<SavedCapyOutfit>()
                .HasIndex(outfit => new { outfit.UserId, outfit.Name });

            builder.Entity<SavedCapyOutfit>()
                .Property(outfit => outfit.Name)
                .HasMaxLength(SavedCapyOutfit.MaxNameLength);

            builder.Entity<CapyItem>().HasData(CapyItemCatalogue.CreateSeedItems());
        }
    }
}
